...
add_action('acf/init', function (): void {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_vgh_hero_title', 'label' => 'Hero titel', 'name' => 'hero_title', 'type' => 'textarea', 'rows' => 2, 'new_lines' => 'br', 'default_value' => 'Luxe houtbouw, verfijnd tot in detail'],
            ...
            ['key' => 'field_vgh_hero_3d_enabled', 'label' => '3D-element tonen', 'name' => 'hero_3d_enabled', 'type' => 'true_false', 'ui' => 1, 'default_value' => 1],
            ...
            ['key' => 'field_vgh_intro_text', 'label' => 'Intro tekst', 'name' => 'intro_text', 'type' => 'wysiwyg', 'tabs' => 'visual', 'toolbar' => 'basic', 'default_value' => 'Vanuit Terschuur realiseert Van Ginkel Houtbouw maatwerkprojecten in heel Nederland. Elk project begint met aandacht voor de plek, de wens en de juiste detaillering.'],
            ...
            ['key' => 'field_vgh_services_items', 'label' => 'Diensten', 'name' => 'services_items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Dienst toevoegen', 'sub_fields' => [
                ['key' => 'field_vgh_service_title', 'label' => 'Titel', 'name' => 'title', 'type' => 'text'],
                ['key' => 'field_vgh_service_text', 'label' => 'Tekst', 'name' => 'text', 'type' => 'textarea', 'rows' => 3],
            ]],
            ['key' => 'field_vgh_process_title', 'label' => 'Werkwijze titel', 'name' => 'process_title', 'type' => 'text', 'default_value' => 'Een zorgvuldig proces van idee tot oplevering'],
            ['key' => 'field_vgh_process_items', 'label' => 'Werkwijze stappen', 'name' => 'process_items', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Stap toevoegen', 'sub_fields' => [
                ['key' => 'field_vgh_process_step_title', 'label' => 'Titel', 'name' => 'title', 'type' => 'text'],
                ['key' => 'field_vgh_process_step_text', 'label' => 'Tekst', 'name' => 'text', 'type' => 'textarea', 'rows' => 2],
            ]],
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_vgh_contact_form_shortcode', 'label' => 'Formulier shortcode', 'name' => 'contact_form_shortcode', 'type' => 'text', 'instructions' => 'Bijvoorbeeld een Contact Form 7 of Gravity Forms shortcode.'],
        ],
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'field_vgh_configurator_cta_text', 'label' => 'CTA tekst', 'name' => 'configurator_cta_text', 'type' => 'textarea', 'rows' => 3, 'default_value' => 'Uw configuratie wordt straks gekoppeld aan een offerte-aanvraag.'],
        ],
