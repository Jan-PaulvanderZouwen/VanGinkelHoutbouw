...
add_action('wp_enqueue_scripts', function (): void {
    ...
    if (is_page_template('page-templates/template-home.php') || is_page_template('page-templates/template-configurator.php')) {
        wp_enqueue_script('three', 'https://unpkg.com/three@0.165.0/build/three.min.js', [], '0.165.0', true);
        wp_enqueue_script('vgh-three-hero', VGH_THEME_URI . '/assets/js/three-hero.js', ['three'], VGH_THEME_VERSION, true);
    }
