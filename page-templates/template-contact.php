    ...
    <div class="container contact-grid">
        <div class="content-flow">
            ...
            <div class="contact-card">
                <p><strong>Telefoon</strong><br><a href="tel:0342489760"><?php echo vgh_esc_field('contact_phone', '0342-489760'); ?></a></p>
        ...
        <div class="form-panel">
            ...
            echo $shortcode !== '' ? do_shortcode($shortcode) : '<p class="form-placeholder">Plaats hier later de shortcode van het contactformulier via ACF.</p>';
            ?>
        </div>
    </div>
</section>
